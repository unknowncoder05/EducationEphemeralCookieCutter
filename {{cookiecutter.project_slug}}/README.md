...
│   ├── packages/       # Shared domain modules used by this template
...
- **ItemsPage**: Generic CRUD interface for managing removable scaffold items (example module, not a product surface).
...
- `ItemsPage` is removable scaffold for future CRUD modules; replace or delete it when product-specific surfaces are defined.
...
- [x] Shared content primitives package — downloaded from \`community-packages\`
- [x] Shared community graph primitives package — downloaded from \`community-packages\`
- [x] Shared direct messaging primitives package — downloaded from \`community-packages\`
- [x] Shared notifications primitives package — downloaded from \`community-packages\`
- [x] Shared moderation primitives package — downloaded from \`community-packages\`
- [x] Shared media primitives package — downloaded from \`community-packages\`
- [x] Abstract capability package (\`pm-catalog\`) for hierarchy modeling
- [x] Abstract capability package (\`pm-cohorting\`) for participant grouping
- [x] Abstract capability package (\`pm-enrollment\`) for access lifecycle
- [x] Abstract capability package (\`pm-assessment\`) for evaluation flows
- [x] Abstract capability package (\`pm-progress\`) for outcome tracking
- [x] Abstract capability package (\`pm-credentialing\`) for certifications and badges
- [x] Abstract capability package (\`pm-scheduling\`) for sessions and attendance windows
- [x] Abstract capability package (\`pm-policy\`) for configurable business rules
- [x] Abstract capability package (\`pm-analytics\`) for analytics/event aggregation foundations
