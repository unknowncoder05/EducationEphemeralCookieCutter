...
ABSTRACT_CAPABILITY_APPS = [
    ('PM_ENABLE_CATALOG', 'pm_catalog'),
    ('PM_ENABLE_COHORTING', 'pm_cohorting'),
    ('PM_ENABLE_ENROLLMENT', 'pm_enrollment'),
    ('PM_ENABLE_ASSESSMENT', 'pm_assessment'),
    ('PM_ENABLE_PROGRESS', 'pm_progress'),
    ('PM_ENABLE_CREDENTIALING', 'pm_credentialing'),
    ('PM_ENABLE_SCHEDULING', 'pm_scheduling'),
    ('PM_ENABLE_POLICY', 'pm_policy'),
    ('PM_ENABLE_ANALYTICS', 'pm_analytics'),
]
for env_key, app_label in ABSTRACT_CAPABILITY_APPS:
    if env.bool(env_key, default=True):
        THIRD_PARTY_APPS.append(app_label)
...
PM_DEFAULT_LOCALE = env('PM_DEFAULT_LOCALE', default='en')
PM_DEFAULT_TIMEZONE = env('PM_DEFAULT_TIMEZONE', default=TIME_ZONE)
PM_POLICY_STRICT_MODE = env.bool('PM_POLICY_STRICT_MODE', default=False)
PM_PROGRESS_STRATEGY = env('PM_PROGRESS_STRATEGY', default='completion')
PM_ASSESSMENT_SCORING_MODE = env('PM_ASSESSMENT_SCORING_MODE', default='weighted')
