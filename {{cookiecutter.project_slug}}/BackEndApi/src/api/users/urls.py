...
# Views
from .views import *
from .views.bank import BankAccountTypeViewSet, BankViewSet
from .views.bank_information import BankInformationViewSet
from .views.document_type import DocumentTypeViewSet
# Django Rest Framework
from .views.identiy_files import IdentityFilesViewSet
