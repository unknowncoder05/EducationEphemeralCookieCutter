...
3. Validate auth, feed, profile, chat, notifications, and moderation routes load.

## 4) Backlog to Execution
1. Start with the built-in domain areas before inventing new modules:
   content feed, user profiles, follows/blocks, direct messaging, notifications, moderation, and media attachments.
2. Send the selected backlog item to the developer agent from backlog flow.
